...
const sankeyColor = d3.scaleOrdinal()
    .domain(['A', 'B', 'C', 'D', 'F'])
    .range([d3.hsv(200, 0.8810, 0.8235), d3.hsv(138, 0.75, 0.64), d3.hsv(55, 0.75, 0.89), d3.hsv(38, 0.75, 0.9), d3.hsv(8, 0.75, 0.85), d3.hsv(38, 0.75, 0.9)]);
        ...
        for ([index, assessment] of assessments.entries()) {
            ...
            if (index < 3) {
                ...
                if (level === 1) {
                    ...
                    if (nextGrade.localeCompare('FE') === 0) {
                        nextGrade = "0-59";
                    }
                }
                if (level === 2) {
